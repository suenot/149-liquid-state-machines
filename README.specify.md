# Chapter 128: Liquid State Machines для Trading

## Описание

Reservoir computing с liquid state machines для временных рядов.
...
1. **Liquid State Machines: Motivation, Theory, and Applications**
